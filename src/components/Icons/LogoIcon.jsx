const LogoIcon = () => {
  return (
    <svg viewBox='0 0 48 48' width='96' height='96' className='row'>
      <linearGradient
      ...
      <path
        ...
        d='M18.293,27.707l-6-6c-0.391-0.391-0.391-1.024,0-1.414l1.414-1.414c0.391-0.391,1.024-0.391,1.414,0L19,22.758l8.879-8.879c0.391-0.391,1.024-0.391,1.414,0l1.414,1.414c0.391,0.391,0.391,1.024,0,1.414l-11,11C19.317,28.098,18.683,28.098,18.293,27.707z'
      />
    </svg>
  )
}
